    ...
    protected
        def page_number(page)
            unless page == current_page
                link(page, page, :rel => rel_value(page), :class => '')
            else
        ...
        def gap
            ...
            %(<li class="disabled page-item"><a>#{text}</a></li>)
        end
        ...
        def previous_or_next_page(page, text, classname)
            if page
                link(text, page, :class => classname + ' page-item')
            else
                link(text, "#", :class => classname + ' disabled page-item')
            end
        end
